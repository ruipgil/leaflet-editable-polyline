;(function (w) {
  L.Polyline.polylineEditor = L.Polyline.extend({
    ...
    _addMethods: function () {
      ...
      this._parseOptions = function (options) {
        ...
        options.onRemove = options.onRemove || function () {}
        options.onPointAdd = options.onPointAdd || function () {}
        options.onExtend = options.onExtend || function () {}
      ...
      this._reloadPolyline = function (fixAroundPointNo) {
        ...
        that._showBoundMarkers()
        that._changed = true
        console.log(that._lastAction)
        that._options[that._lastAction](fixAroundPointNo, that.getPoints())
      }
  ...
  w.PolylineEditor = L.Polyline.PolylineEditor
